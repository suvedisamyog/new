                    ...
                    <div class="d-flex">
                        <div class="flex-shrink-0 dropdown  me-5 mt-sm-3">
                            <a href="#" class="d-block link-dark text-decoration-none"
                                id="notice-drop-down" data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="fa-solid fa-bell text-white    fa-lg"></i>                            </a>
                            <ul class="dropdown-menu" aria-labelledby="notice-drop-down">
                                <li><a class="dropdown-item" href="#books-holding">a</a></li>
                                <li><a class="dropdown-item" href="#books-holding">a</a></li>
                                ...
                                <div class="mb-5 mt-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            value="<?php echo $row['registration']; ?>" disabled>
                                    </div>
                                </div>
                                <div>
                                    <div class="form-group">
